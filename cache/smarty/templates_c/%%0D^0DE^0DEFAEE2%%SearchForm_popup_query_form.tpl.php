<?php /* Smarty version 2.6.11, created on 2015-05-18 14:14:04
         compiled from cache/modules/AOS_Products/SearchForm_popup_query_form.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'counter', 'cache/modules/AOS_Products/SearchForm_popup_query_form.tpl', 26, false),array('function', 'math', 'cache/modules/AOS_Products/SearchForm_popup_query_form.tpl', 27, false),array('function', 'sugar_getimagepath', 'cache/modules/AOS_Products/SearchForm_popup_query_form.tpl', 35, false),array('function', 'sugar_translate', 'cache/modules/AOS_Products/SearchForm_popup_query_form.tpl', 44, false),array('function', 'html_options', 'cache/modules/AOS_Products/SearchForm_popup_query_form.tpl', 225, false),array('function', 'sugar_getimage', 'cache/modules/AOS_Products/SearchForm_popup_query_form.tpl', 238, false),)), $this); ?>
...
<?php if (strlen ( $this->_tpl_vars['fields']['part_number_advanced']['value'] ) <= 0):  $this->assign('value', $this->_tpl_vars['fields']['part_number_advanced']['default_value']);  else:  $this->assign('value', $this->_tpl_vars['fields']['part_number_advanced']['value']);  endif; ?>  
...
<?php if (strlen ( $this->_tpl_vars['fields']['cost_advanced']['value'] ) <= 0):  $this->assign('value', $this->_tpl_vars['fields']['cost_advanced']['default_value']);  else:  $this->assign('value', $this->_tpl_vars['fields']['cost_advanced']['value']);  endif; ?>  
...
<?php if (strlen ( $this->_tpl_vars['fields']['price_advanced']['value'] ) <= 0):  $this->assign('value', $this->_tpl_vars['fields']['price_advanced']['default_value']);  else:  $this->assign('value', $this->_tpl_vars['fields']['price_advanced']['value']);  endif; ?>  
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='10%' >
		...
		<label for='amount_c_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_AMOUNT','module' => 'AOS_Products'), $this);?>
</label>
    	</td>
	<td  nowrap="nowrap" width='30%'>
			
<?php if (strlen ( $this->_tpl_vars['fields']['amount_c_advanced']['value'] ) <= 0):  $this->assign('value', $this->_tpl_vars['fields']['amount_c_advanced']['default_value']);  else:  $this->assign('value', $this->_tpl_vars['fields']['amount_c_advanced']['value']);  endif; ?>  
<input type='text' name='<?php echo $this->_tpl_vars['fields']['amount_c_advanced']['name']; ?>
' 
    id='<?php echo $this->_tpl_vars['fields']['amount_c_advanced']['name']; ?>
' size='30' 
...
<?php echo smarty_function_html_options(array('id' => 'created_by_advanced','name' => 'created_by_advanced[]','options' => $this->_tpl_vars['fields']['created_by_advanced']['options'],'size' => '6','style' => "width: 150px",'multiple' => '1','selected' => $this->_tpl_vars['fields']['created_by_advanced']['value']), $this);?>
