...
"></button><button type="button" name="btn_clr_<?php echo $this->_tpl_vars['fields']['aos_product_category_name']['name']; ?>
...
addToValidate(\'EditView\', \'maincode\', \'enum\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_MAINCODE','module' => 'AOS_Products','for_js' => true), $this); echo '\' );
...
addToValidate(\'EditView\', \'cost\', \'currency\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_COST','module' => 'AOS_Products','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'cost_usdollar\', \'currency\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_COST_USDOLLAR','module' => 'AOS_Products','for_js' => true), $this); echo '\' );
...
addToValidate(\'EditView\', \'price_usdollar\', \'currency\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_PRICE_USDOLLAR','module' => 'AOS_Products','for_js' => true), $this); echo '\' );
...
addToValidate(\'EditView\', \'product_image\', \'varchar\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_PRODUCT_IMAGE','module' => 'AOS_Products','for_js' => true), $this); echo '\' );
