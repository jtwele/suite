...
"single", 
true
);' ><img src="{sugar_getimagepath file="id-ff-select.png"}"></button><button type="button" name="btn_clr_{$fields.contract_account.name}" id="btn_clr_{$fields.contract_account.name}" tabindex="0" title="{sugar_translate label="LBL_ACCESSKEY_CLEAR_ACCOUNTS_TITLE"}"  class="button lastChild"
...
<tr valign="middle">
<td nowrap>
<input autocomplete="off" type="text" id="{$fields.renewal_reminder_date.name}_date" value="{$fields[$fields.renewal_reminder_date.name].value}" size="11" maxlength="10" title='' tabindex="0" onblur="combo_{$fields.renewal_reminder_date.name}.update();" onchange="combo_{$fields.renewal_reminder_date.name}.update(); "    >
...
<td nowrap>
<div id="{$fields.renewal_reminder_date.name}_time_section"></div>
</td>
</tr>
</table>
