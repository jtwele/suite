...
<li class="selected"><a id="tab1" href="javascript:void(1)"><em>{sugar_translate label='LBL_PANEL_ADVANCED' module='Contacts'}</em></a></li>
</ul>
...
<input type="text" name="{$fields.produkt1_c.name}" class="sqsEnabled" tabindex="1" id="{$fields.produkt1_c.name}" size="" value="{$fields.produkt1_c.value}" title='' autocomplete="off"  	 >
<input type="hidden" name="{$fields.produkt1_c.id_name}" 
id="{$fields.produkt1_c.id_name}" 
value="{$fields.aos_products_id_c.value}">
<span class="id-ff multiple">
<button type="button" name="btn_{$fields.produkt1_c.name}" id="btn_{$fields.produkt1_c.name}" tabindex="1" title="{sugar_translate label="LBL_SELECT_BUTTON_TITLE"}" class="button firstChild" value="{sugar_translate label="LBL_SELECT_BUTTON_LABEL"}"
onclick='open_popup(
"{$fields.produkt1_c.module}", 
600, 
400, 
"", 
true, 
false, 
{literal}{"call_back_function":"set_return","form_name":"EditView","field_to_name_array":{"id":"aos_products_id_c","name":"produkt1_c"}}{/literal}, 
"single", 
true
);' ><img src="{sugar_getimagepath file="id-ff-select.png"}"></button><button type="button" name="btn_clr_{$fields.produkt1_c.name}" id="btn_clr_{$fields.produkt1_c.name}" tabindex="1" title="{sugar_translate label="LBL_ACCESSKEY_CLEAR_RELATE_TITLE"}"  class="button lastChild"
onclick="SUGAR.clearRelateField(this.form, '{$fields.produkt1_c.name}', '{$fields.produkt1_c.id_name}');"  value="{sugar_translate label="LBL_ACCESSKEY_CLEAR_RELATE_LABEL"}" ><img src="{sugar_getimagepath file="id-ff-clear.png"}"></button>
</span>
<script type="text/javascript">
SUGAR.util.doWhen(
		"typeof(sqs_objects) != 'undefined' && typeof(sqs_objects['{$form_name}_{$fields.produkt1_c.name}']) != 'undefined'",
		enableQS
);
</script>
</tr>
...
{if strlen($fields.menge_c.value) <= 0}
{assign var="value" value=$fields.menge_c.default_value }
{else}
{assign var="value" value=$fields.menge_c.value }
{/if}  
<input type='text' name='{$fields.menge_c.name}' 
id='{$fields.menge_c.name}' size='30' maxlength='255' value='{sugar_number_format precision=0 var=$value}' title='' tabindex='2'    >
...
{if strlen($fields.preis_c.value) <= 0}
{assign var="value" value=$fields.preis_c.default_value }
{else}
{assign var="value" value=$fields.preis_c.value }
{/if}  
<input type='text' name='{$fields.preis_c.name}'
id='{$fields.preis_c.name}'
size='30'
...
<input type="text" name="{$fields.produkt2_c.name}" class="sqsEnabled" tabindex="4" id="{$fields.produkt2_c.name}" size="" value="{$fields.produkt2_c.value}" title='' autocomplete="off"  	 >
<input type="hidden" name="{$fields.produkt2_c.id_name}" 
id="{$fields.produkt2_c.id_name}" 
value="{$fields.aos_products_id_c.value}">
<span class="id-ff multiple">
<button type="button" name="btn_{$fields.produkt2_c.name}" id="btn_{$fields.produkt2_c.name}" tabindex="4" title="{sugar_translate label="LBL_SELECT_BUTTON_TITLE"}" class="button firstChild" value="{sugar_translate label="LBL_SELECT_BUTTON_LABEL"}"
onclick='open_popup(
"{$fields.produkt2_c.module}", 
600, 
400, 
"", 
true, 
false, 
{literal}{"call_back_function":"set_return","form_name":"EditView","field_to_name_array":{"id":"aos_products_id_c","name":"produkt2_c"}}{/literal}, 
"single", 
true
);' ><img src="{sugar_getimagepath file="id-ff-select.png"}"></button><button type="button" name="btn_clr_{$fields.produkt2_c.name}" id="btn_clr_{$fields.produkt2_c.name}" tabindex="4" title="{sugar_translate label="LBL_ACCESSKEY_CLEAR_RELATE_TITLE"}"  class="button lastChild"
onclick="SUGAR.clearRelateField(this.form, '{$fields.produkt2_c.name}', '{$fields.produkt2_c.id_name}');"  value="{sugar_translate label="LBL_ACCESSKEY_CLEAR_RELATE_LABEL"}" ><img src="{sugar_getimagepath file="id-ff-clear.png"}"></button>
</span>
<script type="text/javascript">
SUGAR.util.doWhen(
		"typeof(sqs_objects) != 'undefined' && typeof(sqs_objects['{$form_name}_{$fields.produkt2_c.name}']) != 'undefined'",
		enableQS
);
</script>
</tr>
...
{if strlen($fields.menge2_c.value) <= 0}
{assign var="value" value=$fields.menge2_c.default_value }
{else}
{assign var="value" value=$fields.menge2_c.value }
{/if}  
<input type='text' name='{$fields.menge2_c.name}' 
id='{$fields.menge2_c.name}' size='30' maxlength='255' value='{sugar_number_format precision=0 var=$value}' title='' tabindex='5'    >
...
{if strlen($fields.preis2_c.value) <= 0}
{assign var="value" value=$fields.preis2_c.default_value }
{else}
{assign var="value" value=$fields.preis2_c.value }
{/if}  
<input type='text' name='{$fields.preis2_c.name}'
id='{$fields.preis2_c.name}'
size='30'
maxlength='18'value='{sugar_number_format var=$value precision=2 }'
title=''
tabindex='6'
